...
class ToDo:
    def __init__(self,root):
        ...
        self.label2 = Label(self.root , text ='Add Task', 
                           font='ariel, 20 bold',width=10,bd=5,bg='pink', fg='black' )
        self.label2.place(x=40, y=60)

        self.label3 = Label(self.root , text ='Tasks', 
                           font='ariel, 20 bold',width=10,bd=5,bg='pink', fg='black' )
        self.label3.place(x=350 , y=60)

        self.main_text = Listbox(self.root, height=9 , bd= 5 , width = 23 , bg='light blue',font='ariel 20 italic bold')
        self.main_text.place(x=260, y=120)

        self.text = Text(self.root , bd=5, height =2, width =30 , bg = 'light yellow',
                          fg= 'black' , font= 'ariel, 10 bold')
        self.text.place(x=20, y=130)
