...
btn_cancel=Button(root,text="cancel",font=("ariel",12,'bold'),bd=12,height=2,width=6,command=btnClear)
...
btn_equalto=Button(root,text="=",font=("ariel",12,'bold'),bd=12,height=2,width=6,command=btnEquals)
btn_equalto.grid(row=4,column=2)
btn_division=Button(root,text="/",font=("ariel",12,'bold'),bd=12,height=2,width=6,command=lambda:btnClick("/"))
